...
// completer
// call the .playbill action

// test('scriptwriter instances have the correct minimal interface', t => {
// 	const scriptwriter = new Scriptwriter();
// 	t.ok(typeof scriptwriter.init === 'function');
// 	t.ok(typeof scriptwriter.assign === 'function');
// 	console.log(scriptwriter);
// 	t.end();
// });
